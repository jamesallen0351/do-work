...
can refer to stops by name rather than by number. Change the query so that the services between 
...
including 'Craiglockhart' itself, offered by the LRT company. Include the company and bus no. of 
