...
/* 4. Use a different JOIN so that all the departments are listed. */
...
/* 6. Use COALESCE function and a LEFT JOIN to print the teacher name and department name.
...
/* 9. Use CASE to show the name of each techer followed by 'Sci' if the teacher is in dept 1 or 2 and 'Art' otherwise */
