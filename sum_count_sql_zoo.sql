...
/* 7. For each continent show the continent and the number of countries with populations of at least 10 million */
...
WHERE (SELECT SUM(population) FROM world b WHERE a.continent = b.continent) >= 100000000
GROUP BY continent
